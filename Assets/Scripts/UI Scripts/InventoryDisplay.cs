...
public abstract class InventoryDisplay : MonoBehaviour
{
    ...
    public void SlotClicked(InventorySlot_UI clickedUISlot)
    {
        ...
        switch (clickedUISlot.transform.parent.name)
        {
            case "Armor": CustomSlotClicked(clickedUISlot, InventoryItemData.Type.Armor); return;
            case "Weapons": CustomSlotClicked(clickedUISlot, InventoryItemData.Type.Weapon); return;
            case "Talismans": CustomSlotClicked(clickedUISlot, InventoryItemData.Type.Talisman); return;
        }

        //Mouse dosent have an item but slot does
        ...
        //Slot dosent have an item but mouse does
        if(clickedUISlot.AssignedInventorySlot.ItemData == null && mouseInventoryItem.AssignedInventorySlot.ItemData != null)
        {
    ...
    private void CustomSlotClicked(InventorySlot_UI clickedUISlot, InventoryItemData.Type type)
    {
        bool isShiftPressed = Keyboard.current.leftShiftKey.isPressed;
        ...
        if (clickedUISlot.AssignedInventorySlot.ItemData == null && mouseInventoryItem.AssignedInventorySlot.ItemData != null)
        {
            if(mouseInventoryItem.AssignedInventorySlot.ItemData.ItemType == type)
            {
                clickedUISlot.AssignedInventorySlot.AssignItem(mouseInventoryItem.AssignedInventorySlot);
                clickedUISlot.UpdateUISlot();
